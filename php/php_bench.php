...
#  Date        : Aug 13 , 2025                                           #
#  version     : 1.1.2 (PHP 7+ / 8+ Safe Patch)                          #
#  License     : Creative Commons CC-BY license                          #
#  Website     : http://www.php-benchmark-script.com                     #
#  Pulled from : Alessandro Torrisi                                      #
##########################################################################
*/
    ...
    private static function test_Math($count = 140000) {
        ...
        for ($i = 0; $i < $count; $i++) {
            foreach ($mathFunctions as $function) {
                ...
                $numRequired = $refFunc->getNumberOfRequiredParameters();
                ...
                if ($numRequired === 0) {
                    ...
                    switch ($function) {
                        ...
                        case 'asin':
                            ...
                            break;
                        case 'bindec':
                            $val = '101010'; // valid binary string
                            break;
                        default:
                            $val = $i ?: 1; // avoid log(0) type issues
                            break;
                    }
                    $r = $function($val);
                }
